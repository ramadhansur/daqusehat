...
$riwayat_pemeriksaan = mysqli_query($koneksi,"SELECT * FROM tb_pemeriksaan_poliumum WHERE no_rm = '$no_rm' AND status_pelayanan = 'Sudah Dilayani' ORDER BY id asc");
                ...
                <h2>Riwayat Pemeriksaan</h2>
                    <div class="input-details">
                        <details class="details-riwayat-pemeriksaan">
                            ...
                            <div class="container-button-riwayat">
                                <?php if(mysqli_num_rows($riwayat_pemeriksaan)>0){ ?>
                                    <?php
                                        $no = 1;
                                        while($d = mysqli_fetch_array($riwayat_pemeriksaan)){
                                    ?>
                                        <a  href="#" class="riwayat-pemeriksaan" data-id='<?php echo $d['no_reg'] ?>' data-bs-toggle='modal' data-bs-target='#moreinfo'><?php $tanggal = $d['tanggal_masuk']; echo date("d-m-Y", strtotime($tanggal)) ?></a>
                                    <?php $no++; } ?>
                                <?php } ?>
                            </div>
                        </details>
            ...
            <div class="registrasi">
                ...
                <h2>Hasil Cek</h2>
                    <div class="input-details">
                        ...
                        <div class="inputbox">
                            <span class="detil">Alergi</span>
                             <h3><?= $dp['alergi_makanan']; ?>, <?= $dp['alergi_udara']; ?>, <?= $dp['alergi_obat']; ?></h3>
                        </div>
                    </div>
